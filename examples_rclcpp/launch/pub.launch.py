...
def generate_launch_description():
    comment = LaunchConfiguration('comment', default='Hi')
    ...
    param_dir = LaunchConfiguration(
        ...
        default=os.path.join(
            get_package_share_directory('examples_rclcpp'),
            'param',
    ...
    return LaunchDescription([
        LogInfo(msg=['Execute publisher!!']),

        DeclareLaunchArgument(
            'comment',
            default_value=comment,
            description='Specifying a comment'),
        ...
        Node(
            ...
            arguments=['-c', comment, '-q', qos_profile],
