...
from examples_rclpy.subscriber.observer import Observer


def main(argv=sys.argv[1:]):
    parser = argparse.ArgumentParser(description='For subscriber(observer) node:')
    parser.add_argument(
        '-q',
        '--qos_profile',
        type=int,
    ...
    node = Observer(args.qos_profile)
